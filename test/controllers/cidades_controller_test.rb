...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { belongs_to: @cidade.belongs_to, codigo_ibge: @cidade.codigo_ibge, estado: @cidade.estado, nome: @cidade.nome } }, as: :json
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { belongs_to: @cidade.belongs_to, codigo_ibge: @cidade.codigo_ibge, estado: @cidade.estado, nome: @cidade.nome } }, as: :json
    assert_response 200
  end
